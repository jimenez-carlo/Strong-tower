    ...
    success: function (res) {
      ...
      if (result.status == true) {
       if (form_name == 'update_user' && type_value == 'delete_user') {
         $( "#content" ).load( base_url+'page.php?page=users' );
       }
       ...
       if (form_name == 'update_user' && type_value == 'delete_customer') {
         $( "#content" ).load( base_url+'page.php?page=customers' );
       }
       if (form_name == 'remove_from_cart' || form_name == 'update_cart' || form_name == 'checkout_cart') {
         $( "#content" ).load( base_url+'page.php?page=cart' );
        }
        
       if (form_name == 'update_transaction' && type_value == '5') {
         $( "#content" ).load( base_url+'page.php?page=customer_orders' );
        }
       if (form_name == 'update_transaction' && (type_value == '3' || type_value == '6')) {
         $( "#content" ).load( base_url+'page.php?page=transactions' );
        }
       if (form_name == 'update_transaction_view' && (type_value == '3' || type_value == '6')) {
         $( "#content" ).load( base_url+'page.php?page=transaction_view&id=' +formdata.get('id'));
        }
        
        if (form_name == 'update_order' && (type_value == '3' || type_value == '6')) {
         $( "#content" ).load( base_url+'page.php?page=orders' );
        }
       if (form_name == 'update_orders_view' && (type_value == '3' || type_value == '6')) {
         $( "#content" ).load( base_url+'page.php?page=orders_view&id=' +formdata.get('id'));
        }
       if (form_name == 'update_order_transaction' && (type_value == '3' || type_value == '6')) {
         $( "#content" ).load( base_url+'page.php?page=orders_view&id=' +formdata.get('invoice_id'));
        }
        
       if (form_name == 'update_category' && type_value == 'delete') {
         $( "#content" ).load( base_url+'page.php?page=categories' );
        }
        if (form_name == 'update_category' && type_value == 'update') {
         $( "#content" ).load( base_url+'page.php?page=category_edit&id='+formdata.get('category_id') );
        }
       ...
       if (form_name == 'update_product' && type_value == 'delete') {
         $( "#content" ).load( base_url+'page.php?page=products' );
       }
       if (form_name == 'update_product' && type_value == 're_stock_list') {
         $( "#content" ).load( base_url+'page.php?page=inventory' );
       }
       if (form_name == 'update_product' && type_value == 're_stock') {
         $( "#content" ).load( base_url+'page.php?page=inventory_edit&id='+formdata.get('product_id') );
        }
       if (form_name == 'update_product' && type_value == 'update') {
         $( "#content" ).load( base_url+'page.php?page=product_edit&id='+formdata.get('product_id') );
        }
      }
      if (result.items != '') {
