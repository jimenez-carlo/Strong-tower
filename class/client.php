...
class Client extends Base
{
  ...
  public function create()
  {
    ...
    try {
      ...
      $result->status = true;
      $result->result = $this->response_success("Client Created Successfully!", 'Successfull!');
      return $result;
  ...
  public function update()
  {
    ...
    try {
      ...
      $this->commit_transaction();
      $result->status = true;
      $result->result = $this->response_success("Client Updated Successfully!", 'Successfull!');
      return $result;
    } catch (mysqli_sql_exception $exception) {
      $this->roll_back();
      $result->result = $this->response_error();
