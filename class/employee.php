...
class Employee extends Base
{
  ...
  public function create()
  {
    ...
    try {
      ...
      $result->status = true;
      $result->result = $this->response_success("Employee Created Successfully!", 'Successfull!');
      return $result;
  ...
  public function update()
  {
    ...
    $check_user_name = $this->get_one("SELECT if(max(b.id) is null, 0, max(b.id) + 1) as `res` from tbl_user b where b.username ='$username' and id <> $id  and deleted_flag = 0 limit 1");
    ...
    try {
      ...
      $this->commit_transaction();
      $result->status = true;
      $result->result = $this->response_success("Employee Updated Successfully!", 'Successfull!');
      return $result;
    } catch (mysqli_sql_exception $exception) {
      $this->roll_back();
      $result->result = $this->response_error();
  ...
  public function delete($id)
  {
    ...
    try {
      ...
      $this->commit_transaction();
      $result->status = true;
      $result->result = $this->response_success("Employee Deleted Successfully!", 'Successfull!');
      return $result;
    } catch (mysqli_sql_exception $exception) {
      $this->roll_back();
      $result->result = $this->response_error();
